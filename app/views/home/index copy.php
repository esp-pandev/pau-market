    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="<?php echo BASE_URL; ?>home/productDisplay">Products</a></li>
        ...
        <?php if (!empty($featuredProducts)): ?>
            <?php foreach ($featuredProducts as $product): ?>
                <div class="product-card">
                    <div class="product-img" style="background-image: url('<?php echo BASE_URL . ($product['image'] ?: 'assets/images/default-product.jpg'); ?>');"></div>
                    <div class="product-content">
                        <h4><?php echo htmlspecialchars($product['name']); ?></h4>
                        <p class="price">$<?php echo number_format($product['price'], 2); ?>/<?php echo htmlspecialchars($product['unit']); ?></p>
                        <p><?php echo htmlspecialchars($product['description']); ?></p>
                        <a href="<?php echo BASE_URL; ?>products/show/<?php echo $product['id']; ?>" class="btn" style="display: inline-block; padding: 0.5rem 1rem; margin-top: 0.5rem; font-size: 0.9rem;">View Details</a>
                    </div>
                </div>
            <?php endforeach; ?>
        <?php else: ?>
