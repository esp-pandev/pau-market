...
<body>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="<?= BASE_URL ?>products/store" id="product-form" method="POST" enctype="multipart/form-data">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control" id="quantity_available" name="quantity_available" value="0" required>
...
<!-- Optional: Add this for client-side validation -->
<script>
